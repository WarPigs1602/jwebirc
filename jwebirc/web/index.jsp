...
<form method="POST" name="login" action="" target="_top" accept-charset="utf-8">
    ...
    <input class="form-control form-control-sm" maxlength="15" name="nick" value="<% out.print(paramN); %>" placeholder="Nickname">
    <input class="form-control form-control-sm" maxlength="200" name="channel" value="<% out.print(paramC); %>" placeholder="Channel">
